<template>
  <div class="main">
    ...
    <!--Controller Nav-->
    <div
      class="flex justify-between h-20 mx-64 mt-8 p-5 rounded-md shadow-sm bg-white text-2xl"
    >
    ...
    <div class="area flex mx-64">
      ...
      <!--Conteúdo principal-->
      <div class="content h-screen w-screen mt-5">
        <Card
          :class="
